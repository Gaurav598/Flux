/**
 * Flux — shared dark "black Uber" theme.
 * Use these tokens across all screens so the look stays consistent.
 */
export const colors = {
  // Surfaces
  bg: '#000000', // app background (pure black, Uber dark)
  surface: '#1A1A1B', // cards / sheets (Uber backgroundSecondary)
  surfaceAlt: '#242426', // inputs, secondary cards
  surfaceHigh: '#2E2E31', // pressed / elevated
  border: '#2A2A2C', // hairline borders (Uber borderOpaque)
  borderStrong: '#3A3A3D',

  // Text (Uber content tokens)
  text: '#FFFFFF', // contentPrimary
  textSub: '#B0B0B0', // contentSecondary
  textMute: '#8A8A8A', // contentTertiary
  textFaint: '#5A5A5A',
  ...
  success: '#36C271', // Uber positive green
...
/** Static requires so Metro can bundle the vehicle art. */
